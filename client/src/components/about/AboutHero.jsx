...
const AboutHero = () => {
  return (
    <section className="relative min-h-[220px] sm:min-h-[280px] md:min-h-[36vh] flex items-center pt-14 pb-8 sm:pt-16 sm:pb-12 md:pt-20 md:pb-16 px-4 sm:px-6 overflow-hidden bg-[#040D1A] text-white">
      ...
      <div className="max-w-5xl mx-auto text-center flex flex-col items-center relative z-10">
        <motion.div
          ...
          className="w-full"
        >
          <div className="hidden sm:inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 mb-3 sm:mb-4 backdrop-blur-md">
            <Sparkles size={14} className="text-emerald-400 animate-pulse" />
            <span className="text-[11px] sm:text-xs font-semibold tracking-wider text-emerald-300 uppercase">ABOUT VMANOUS</span>
          </div>
