            ...
            return (
              ...
              >
                <div className="relative">
                  <div className={`
                    px-2 py-1 xs:px-3 xs:py-1.5 md:px-4 md:py-2 rounded-2xl sm:rounded-full cursor-pointer border backdrop-blur-xl transition-all duration-300 text-[10px] xs:text-xs font-semibold flex items-center gap-1.5 text-center
                    ${isActive
