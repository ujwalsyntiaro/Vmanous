              ...
              <div key={step.step} className="relative">
                ...
                >
                  <div className={`flex-1 w-full text-center ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                    <div className="inline-block px-3 py-1 bg-white/5 rounded-lg text-vmanous-ai-blue font-mono font-medium text-sm mb-3 border border-white/10">
                      Step {step.step}
                    </div>
                    <h3 className="text-xl md:text-2xl md: font-medium text-white mb-3">{step.title}</h3>
                    <p className="text-gray-400 text-lg">{step.description}</p>
                  </div>
                  
                  <div className="relative shrink-0 w-24 h-24 rounded-full border-4 border-[#080B1A] bg-gradient-to-br from-vmanous-ai-blue to-purple-600 flex items-center justify-center shadow-lg shadow-vmanous-ai-blue/20 z-10">
                ...
                {index < dataScienceWorkflow.length - 1 && (
                  <div className="flex justify-center my-4 md:my-0">
                    <div className="w-1 md:absolute left-1/2 md:-ml-0.5 h-16 md:h-full bg-gradient-to-b from-vmanous-ai-blue/50 to-transparent top-24 -bottom-8 rounded-full flex justify-center z-0">
                      <motion.div 
