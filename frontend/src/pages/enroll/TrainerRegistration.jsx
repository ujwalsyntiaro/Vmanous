    ...
    <div className="min-h-[70vh] pt-32 pb-20 flex items-center justify-center bg-gray-50">
      <Container>
        <div className="max-w-2xl mx-auto bg-white p-12 rounded-3xl border border-gray-100 shadow-sm text-center">
          <h1 className="text-3xl md:text-4xl font-medium text-vmanous-navy-dark mb-4">Trainer Registration</h1>
          <p className="text-gray-600 mb-8">
            This is a placeholder for the future trainer registration flow. Architecture is ready for integration.
          </p>
          <Link 
            to="/enroll" 
