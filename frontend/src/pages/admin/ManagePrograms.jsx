              ...
              <tbody className="divide-y divide-gray-100">
                {summits.map((summit) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="font-bold text-vmanous-navy-dark">
                        {summit.title}
                      </div>
                    ...
                    <td className="px-6 py-4 space-y-1">
                      <div className="font-bold text-emerald-600 text-sm">
                        ...
                        {summit.originalPrice &&
                          Number(summit.originalPrice) >
                            Number(summit.price) && (
                            <span className="text-xs text-gray-400 line-through font-normal ml-2">
                              ₹
                              {Number(summit.originalPrice).toLocaleString(
                                "en-IN",
                              )}
                            </span>
                          )}
                      ...
                      <div className="text-xs text-gray-500 flex items-center gap-1">
                        ...
                        <span>
                          {summit.taxMode === "Inclusive"
                            ? "Tax Included"
                            : summit.taxRate
                              ? `+${summit.taxRate}% GST (${summit.taxMode || "Exclusive"})`
                              : "Free"}
                        </span>
                      </div>
                    </td>
                ...
                {summits.length === 0 && (
                  <tr>
                    ...
                    >
                      No programs found. Add a new program to display on the
                      enroll page.
                    </td>
                  </tr>
                )}
