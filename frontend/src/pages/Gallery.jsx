...
export const Gallery = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans text-vmanous-navy-dark">
      {/* 01 HERO BANNER */}
      <section className="relative min-h-[230px] sm:min-h-[260px] md:min-h-[30vh] flex items-center w-full pt-16 pb-14 sm:pt-20 sm:pb-16 md:pt-22 md:pb-18 overflow-hidden bg-[#050816] text-white">
            ...
            <div className="grid grid-cols-4 gap-1.5 w-full">
              ...
              >
                ...
                <span className={`px-1 py-0.2 rounded-md text-[9px] font-bold ${
                  ...
                  {galleryItems.filter(i => i.category === 'ai-summit').length}
                </span>
              </button>
              ...
              >
                ...
                <span className={`px-1 py-0.2 rounded-md text-[9px] font-bold ${
                  ...
                  {galleryItems.filter(i => i.category === 'workshops').length}
                </span>
              </button>
